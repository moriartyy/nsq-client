...
public class Config {
    ...
    private String userAgent = "JavaNSQClient/1.0.0.RC4-M1";
    private Integer msgTimeout = null;
    private SslContext sslContext = null;
    private EventLoopGroup eventLoopGroup = null;
    // 订阅者是否在收到消息后立即标记成已完成处理
    ...
    public Config(String clientId, String hostname) {
    ...
    public Config setMaxInFlight(final int maxInFlight) {
    ...
    public boolean isFastFinish() {
        return fastFinish;
    }

    public void setFastFinish(boolean fastFinish) {
